...
public:
	...
	static int getLargeurBlocAlien(int niveau) {
		switch (niveau) {
		case 1:
			return LARGEUR_BLOC_ALIEN_NIV_1;
			break;
		case 3:
			return LARGEUR_BLOC_ALIEN_NIV_2;
			break;
		case 5:
			return LARGEUR_BLOC_ALIEN_NIV_3;
			break;
		case 7:
			return LARGEUR_BLOC_ALIEN_NIV_4;
			break;
		case 9:
			return LARGEUR_BLOC_ALIEN_NIV_5;
			break;
		}
		return 1;
	}
	static int getHauteurBlocAlien(int niveau) {
		switch (niveau) {
		case 1:
			return HAUTEUR_BLOC_ALIEN_NIV_1;
			break;
		case 3:
			return HAUTEUR_BLOC_ALIEN_NIV_2;
			break;
		case 5:
			return HAUTEUR_BLOC_ALIEN_NIV_3;
			break;
		case 7:
			return HAUTEUR_BLOC_ALIEN_NIV_4;
			break;
		case 9:
			return HAUTEUR_BLOC_ALIEN_NIV_5;
			break;
		}
		return 1;
	}
	static int getVitesseMissileAlien(int niveau) {
		switch (niveau) {
		case 1:
			return VIT_MISSILE_ALIEN_NIV_1;
			break;
		case 3:
			return VIT_MISSILE_ALIEN_NIV_2;
			break;
		case 5:
			return VIT_MISSILE_ALIEN_NIV_3;
			break;
		case 7:
			return VIT_MISSILE_ALIEN_NIV_4;
			break;
		case 9:
			return VIT_MISSILE_ALIEN_NIV_5;
			break;
		case 2:
			return VIT_MISSILE_BOSS_NIV_1;
			break;
		case 4:
			return VIT_MISSILE_BOSS_NIV_2;
			break;
		case 6:
			return VIT_MISSILE_BOSS_NIV_3;
			break;
		case 8:
			return VIT_MISSILE_BOSS_NIV_4;
			break;
		case 10:
			return VIT_MISSILE_BOSS_NIV_5;
			break;
		}
		return 0;
	}
	static int getVitesseDeplacementBlocAlien(int niveau) {
		switch (niveau) {
		case 1:
			return VIT_DEPL_BLOC_ALIEN_NIV_1;
			break;
		case 3:
			return VIT_DEPL_BLOC_ALIEN_NIV_2;
			break;
		case 5:
			return VIT_DEPL_BLOC_ALIEN_NIV_3;
			break;
		case 7:
			return VIT_DEPL_BLOC_ALIEN_NIV_4;
			break;
		case 9:
			return VIT_DEPL_BLOC_ALIEN_NIV_5;
			break;
		case 2:
			return VIT_DEPL_BLOC_BOSS_NIV_1;
			break;
		case 4:
			return VIT_DEPL_BLOC_BOSS_NIV_2;
			break;
		case 6:
			return VIT_DEPL_BLOC_BOSS_NIV_3;
			break;
		case 8:
			return VIT_DEPL_BLOC_BOSS_NIV_4;
			break;
		case 10:
			return VIT_DEPL_BLOC_BOSS_NIV_5;
			break;
		}
		return 0;
	}
	static int getNombreMissilesAliensMax(int niveau) {
		switch (niveau) {
		case 1:
			return MISSILES_ALIENS_MAX_NIV_1;
			break;
		case 3:
			return MISSILES_ALIENS_MAX_NIV_2;
			break;
		case 5:
			return MISSILES_ALIENS_MAX_NIV_3;
			break;
		case 7:
			return MISSILES_ALIENS_MAX_NIV_4;
			break;
		case 9:
			return MISSILES_ALIENS_MAX_NIV_5;
			break;
		case 2:
			return MISSILES_BOSS_MAX_NIV_1;
			break;
		case 4:
			return MISSILES_BOSS_MAX_NIV_2;
			break;
		case 6:
			return MISSILES_BOSS_MAX_NIV_3;
			break;
		case 8:
			return MISSILES_BOSS_MAX_NIV_4;
			break;
		case 10:
			return MISSILES_BOSS_MAX_NIV_5;
			break;
		}
		return 0;
	}
	static int getPVAliens(int niveau) {
		switch (niveau) {
		case 1:
			return PV_ALIENS_NIV_1;
			break;
		case 3:
			return PV_ALIENS_NIV_2;
			break;
		case 5:
			return PV_ALIENS_NIV_3;
			break;
		case 7:
			return PV_ALIENS_NIV_4;
			break;
		case 9:
			return PV_ALIENS_NIV_5;
			break;
		case 2:
			return PV_BOSS_NIV_1;
			break;
		case 4:
			return PV_BOSS_NIV_2;
			break;
		case 6:
			return PV_BOSS_NIV_3;
			break;
		case 8:
			return PV_BOSS_NIV_4;
			break;
		case 10:
			return PV_BOSS_NIV_5;
			break;
		}
		return 0;
	}
	static int getNbBunkers(int niveau) {
		...
		case 1:
		case 2:
			return NB_BUNKER_NIV_1;
			break;
		case 3:
		case 4:
			return NB_BUNKER_NIV_2;
			break;
		case 5:
		case 6:
			return NB_BUNKER_NIV_3;
			break;
		case 7:
		case 8:
			return NB_BUNKER_NIV_4;
			break;
		case 9:
		case 10:
			return NB_BUNKER_NIV_5;
			break;
		}
		return 0;
	}
