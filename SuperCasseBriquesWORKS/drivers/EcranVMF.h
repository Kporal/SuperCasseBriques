...
public:
	...
	void
	afficherCaractere(Couleur prPlan, Couleur arPlan, const char caractere);
	...
	void
	afficherMot(int l, int c, const char *mot, Couleur premierPlan = BLANC);
	 ...
	 */
	void afficherBase(unsigned int entier, int base = 10,
			Couleur prPlan = BLANC);
