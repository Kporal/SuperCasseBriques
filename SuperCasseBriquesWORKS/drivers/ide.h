...
enum ide_device_type_t {
	IDE_DEVICE_NONE, IDE_DEVICE_HARDDISK, IDE_DEVICE_CDROM
};
enum ideDevice {
	IDE_DEVICE_MASTER, IDE_DEVICE_SLAVE
};
enum presence {
	IDE_CTRL_NOT_PRESENT, IDE_CTRL_PRESENT
};
 ...
 * Lecture du disque.
 ***/
sextant_ret_t ide_read_device(struct ide_device*, vaddr_t dest_buf,
		luoffset_t block_offset, int);
/***
 ...
 ***/
sextant_ret_t ide_write_device(struct ide_device*, vaddr_t src_buf,
		luoffset_t block_offset, int);
